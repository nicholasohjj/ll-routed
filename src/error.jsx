...
body {
  ...
  font-family: 'YourDefaultBodyFont', sans-serif; /* Replace 'YourDefaultBodyFont' with your actual font */
}

h1, h2, h3, h4, h5, h6 {
  font-family: 'YourDefaultHeadingFont', sans-serif; /* Replace 'YourDefaultHeadingFont' with your actual font */
}
